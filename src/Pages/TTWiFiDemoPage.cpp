...
void TTWiFiDemoPage::buildContent(lv_obj_t* screen) {
    ...
    lv_label_set_text(desc, "WiFi config demo.");
...
void TTWiFiDemoPage::onBackClicked(lv_event_t* e) {
    TTWiFiDemoPage* self = (TTWiFiDemoPage*)lv_event_get_user_data(e);
