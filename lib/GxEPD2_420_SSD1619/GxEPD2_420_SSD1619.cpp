...
#define USE_FULL_LUT_FOR_PARTIAL 0

#if USE_FULL_LUT_FOR_PARTIAL
static const uint8_t LUT_FULL_SSD1619[LUT_PARTIAL_BYTES] = {
...
void GxEPD2_420_SSD1619::_Update_Part()
{
  if (!_partial_lut_loaded)
  {
    ...
    _writeCommand(0x32);
#if USE_FULL_LUT_FOR_PARTIAL
    _writeData(LUT_FULL_SSD1619, LUT_PARTIAL_BYTES);
#else
